...
CREATE TABLE `member` (
  ...
  KEY `fk_member_event` (`id_event`),
  CONSTRAINT `fk_member_event` FOREIGN KEY (`id_event`) REFERENCES `events` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `member_discount_rules` (
  ...
  `tipe_target` enum('kategori','merk','produk') NOT NULL,
...
CREATE TABLE `promo` (
  ...
  `kode_promo` varchar(20) DEFAULT NULL COMMENT 'Kode promo jika ada',
  PRIMARY KEY (`id_promo`),
  KEY `id_tipe` (`id_tipe`),
  CONSTRAINT `promo_ibfk_1` FOREIGN KEY (`id_tipe`) REFERENCES `tipe_promo` (`id_tipe`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `promo_rules` (
  ...
  `diskon_nilai` decimal(10,2) DEFAULT NULL COMMENT 'Besaran diskon dalam rupiah',
  PRIMARY KEY (`id_rule`),
  KEY `id_promo` (`id_promo`),
...
DROP TABLE IF EXISTS `tipe_promo`;

CREATE TABLE `tipe_promo` (
  `id_tipe` int(11) NOT NULL AUTO_INCREMENT,
  `nama_tipe` varchar(50) NOT NULL COMMENT 'Regular/Member Only/Special Event',
  `keterangan` text DEFAULT NULL,
  PRIMARY KEY (`id_tipe`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `tipe_promo` */
